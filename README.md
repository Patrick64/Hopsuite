...
If you want to use it, please buy it. :) [Devot-ee](https://devot-ee.com/add-ons/hopsuite)

## Documentation

[More information, how to use...](ee3x-4x/system/user/addons/hopsuite/README.md)
